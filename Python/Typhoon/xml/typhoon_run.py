...
if __name__ == '__main__':
    ...
    VIS_path = upload_file_dir + '/' + xml_parsed.VIS + '.awx'
    IR1_path = upload_file_dir + '/' + xml_parsed.IR1 + '.awx'
    IR2_path = upload_file_dir + '/' + xml_parsed.IR2 + '.awx'
    WV_path = upload_file_dir + '/' + xml_parsed.WV + '.awx'
    SWIR_path = upload_file_dir + '/' + xml_parsed.SWIR + '.awx'
